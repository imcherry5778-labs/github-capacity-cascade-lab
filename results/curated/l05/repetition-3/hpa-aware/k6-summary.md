...
| Scenario | hpa-aware |
| Learning Unit | L05 |
| Logical Requests | 450 |
| Physical Attempts | 450 |
| Retry Attempts | 0 |
| Retry Amplification | 1.000x |
| Logical Failure Rate | 33.56% |
| Logical Duration P95 | 1002.00 ms |
| HTTP Request Duration P95 | 1001.93 ms |
| Downstream status 200 | 299 |
| Downstream status 503 | 151 |
