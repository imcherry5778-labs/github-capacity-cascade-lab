...
| Physical Attempts | 513 |
| Retry Attempts | 293 |
| Retry Amplification | 2.332x |
| Logical Failure Rate | 64.09% |
| Logical Duration P95 | 1004.00 ms |
| HTTP Request Duration P95 | 1002.43 ms |
| Downstream status 200 | 79 |
| Downstream status 503 | 141 |
...
- Logical ID namespace: l06-cascade-pair
