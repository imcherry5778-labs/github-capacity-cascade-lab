...
| Physical Attempts | 544 |
| Retry Attempts | 324 |
| Retry Amplification | 2.473x |
| Logical Failure Rate | 60.45% |
| Logical Duration P95 | 1212.15 ms |
| HTTP Request Duration P95 | 1002.34 ms |
| Downstream status 200 | 87 |
| Downstream status 429 | 0 |
| Downstream status 503 | 133 |
