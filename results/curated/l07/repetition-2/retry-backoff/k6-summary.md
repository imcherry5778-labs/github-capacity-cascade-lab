...
| Physical Attempts | 525 |
| Retry Attempts | 305 |
| Retry Amplification | 2.386x |
| Logical Failure Rate | 61.36% |
| Logical Duration P95 | 1096.45 ms |
| HTTP Request Duration P95 | 1002.31 ms |
| Downstream status 200 | 85 |
| Downstream status 429 | 0 |
| Downstream status 503 | 135 |
