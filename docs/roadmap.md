...
- **Status:** Complete — implementation verified; 3 clean-source fixed-condition repetitions with abort safety and cleanup are curated as local exploratory evidence.
